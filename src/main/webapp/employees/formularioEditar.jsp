                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="job_id" id="job_id">
                                <% for(Job job: listaTrabajos){%>
                                    <!--<% if(empleado.getJob().getJobId().equals(job.getJobId())){%>
                                <option value="<%= job.getJobId()%>" selected><%=job.getJobTitle()%></option>
                                <%} else {%>
                                <option value="<%= job.getJobId()%>"><%=job.getJobTitle()%></option>
                                <%}%>-->
                                <option value="<%= job.getJobId()%>"<%=empleado.getJob().getJobId().equals(job.getJobId())?"selected":""%>><%=job.getJobTitle()%></option>
                                <%}%>
                            </select>
                        </div>
                        <div class="form-group">
